...
namespace MagicStorage
{
    public class UIButtonChoice : UIElement
    {
        ...
        {
            Texture2D backTexture = ModContent.GetTexture("MagicStorage/SortButtonBackground").Value;
            Texture2D backTextureActive = ModContent.GetTexture("MagicStorage/SortButtonBackgroundActive").Value;
